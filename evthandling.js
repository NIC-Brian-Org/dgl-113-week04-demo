...
function evtHandler2() {
  alert("This event handler add a class to the navbar to change its background color.");
  document.querySelector("nav").className = "setBackColor";
}

function evtHandler3() {
  alert("This event handler add a class to main h2 to change its font.");
  document.querySelector("main h2").className = "setFont";
}